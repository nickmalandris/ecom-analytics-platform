    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between bg-sidebar p-12 text-sidebar-foreground">
        ...
        <div>
          ...
          <p className="mt-3 text-[15px] text-sidebar-muted leading-relaxed">
            Connect your Shopify store and Meta Ads account. Get actionable
            insights powered by AI within minutes.
          </p>
        </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1.5 text-sm text-gray-500">Get started with your free analytics dashboard</p>
